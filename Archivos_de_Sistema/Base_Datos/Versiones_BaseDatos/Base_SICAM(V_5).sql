...
INSERT INTO Administrador (Numero_Cuenta, Nombre_usuario, Contrasena, Correo, Nombre_Completo, Telefono)
VALUES (00000000, 'admin0', 'omnissiah', 'admin0@gmail.com', 'Admin cero', '3128429212');

INSERT INTO Profesor (Numero_Cuenta, Nombre_usuario, Contrasena, Correo, Nombre, Telefono, Fecha_nacimiento, Apellidos)
VALUES (00000000, 'profesordummy', 'secreta123', 'profesor@example.com', 'dummy', '5551234567', '1990-01-01', 'dummy');

INSERT INTO Alumno (Numero_Cuenta, Nombre_usuario, Nombre, Apellidos, Fecha_nacimiento, Correo, Contrasena)
VALUES (12345, 'alumno123', 'Juan', 'Pérez', '2000-01-01', 'juan@example.com', 'secreta123');
